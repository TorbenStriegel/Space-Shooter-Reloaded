...
public class Score {
	...
	private Spieltimer spieltimer = new Spieltimer(0,var);
	...
	public void scoreEintragen() {
		mySQL_Datenbank.Werte_eintragen(raumschiffTyp, level, Var.name, getFinalScore(), getTreffergenauigkeit(),
				getSchuesseGetroffen());
	}
	
	public void zeitdazurechnen(){
		finalscore=finalscore+finalscore/50*spieltimer.getZeit_Millisekunden();
	}
	...
	public void setSpieltimer(Spieltimer spieltimer) {
